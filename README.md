...
This project is an ETL pipeline designed for a [dataset](https://goo.gl/ME6hjp) on assessments hosted on by an ed tech service. After the data is extracted, transformed, and loaded into a queryable form, some exploratory analysis showcases useful queries for the users of the service. The project uses:
  - Kafka
  - Spark
  - Hadoop
